            ...
            <div id="content">
                ...
                <div class="post">
                    ...
                    <p class="meta">Posted by <a href="#"><?php the_author();?></a> <?php the_date();?>
                        &nbsp;&bull;&nbsp; <a href="#" class="comments">Comments (64)</a> &nbsp;&bull;&nbsp; <a href="<?php echo get_the_permalink(get_the_ID())  ?>" class="permalink">Full article</a></p>
                    <div class="entry">
                        <p><a href="<?php echo get_the_permalink(get_the_ID())  ?>"><img src="<?php the_post_thumbnail('post-thumbnail', ['class' => 'img-responsive responsive--full alignleft border', 'title' => 'Feature image'])
?>"/></a><?php the_excerpt()?></p>
                    </div>
                </div>
                <?php 
